...
export class CreateGlMaterialInfoDto {
  @ApiProperty({ example: 'S', description: '分类编号' })
  @IsNotEmpty()
  @IsString()
  category: string;

  @ApiProperty({ example: '高碱度烧结矿1', description: '原料名称' })
  @IsNotEmpty()
  @IsString()
  name: string;
  ...
  @ApiProperty({ example: '其他粉矿', description: '产地' })
  @IsOptional()
  @IsString()
  origin?: string;
