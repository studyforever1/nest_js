...
@ApiTags('外购块矿成分价格信息管理')
@Controller('api/v1/lump-econ-info')
...
export class LumpEconInfoController {
  ...
  @Post()
  @ApiOperation({ summary: '创建外购块矿成分价格信息' })
  @UseGuards(PermissionsGuard)
  @Permissions('lump-econ-info:create')
  async create(@Body() data: any) { return await this.service.create(data); }

  @Get()
  @ApiOperation({ summary: '获取外购块矿成分价格信息列表' })
  @UseGuards(PermissionsGuard)
  @Permissions('lump-econ-info:read')
  async findAll() { return await this.service.findAll(); }

  @Get(':id')
  @ApiOperation({ summary: '获取单个外购块矿成分价格信息' })
  @UseGuards(PermissionsGuard)
  @Permissions('lump-econ-info:read')
  async findOne(@Param('id') id: string) { return await this.service.findOne(id); }

  @Patch(':id')
  @ApiOperation({ summary: '更新外购块矿成分价格信息' })
  @UseGuards(PermissionsGuard)
  @Permissions('lump-econ-info:update')
  async update(@Param('id') id: string, @Body() data: any) { return await this.service.update(id, data); }

  @Delete(':id')
  @ApiOperation({ summary: '删除外购块矿成分价格信息' })
  @UseGuards(PermissionsGuard)
  @Permissions('lump-econ-info:delete')
