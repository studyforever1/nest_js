...
export class LLYTHStartTaskResponseDto {
  @ApiProperty({ description: '任务 UUID', example: '铁前一体化配料计算I' })
  taskUuid: string;
...
export class LLYTHStopTaskResponseDto {
...
export class LLYTHProgressResponseDto {
  @ApiProperty({ description: '任务 UUID', example: 'uuid-1234-5678' })
  taskUuid: string;
